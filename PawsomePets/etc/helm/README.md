...
```
127.0.0.1 pawsomepets-local-web
127.0.0.1 pawsomepets-local-webgateway
127.0.0.1 pawsomepets-local-authserver
```
...
Now, you can browse the URL: `https://pawsomepets-local-web`
