...
namespace PawsomePets.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("PawsomePets") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "PawsomePets", DisplayName = "PawsomePets API", Resources = { "PawsomePets" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["PawsomePets_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["PawsomePets_App:RootUrl"]?.TrimEnd('/');
        ...
        //Mobile Client
        var mobileClientId = configurationSection["PawsomePets_Mobile:ClientId"];
        if (!mobileClientId.IsNullOrWhiteSpace())
        {
            var mobileClientRootUrl = configurationSection["PawsomePets_Mobile:RootUrl"]?.Replace("_", "-");
            await CreateApplicationAsync(
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["PawsomePets_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["PawsomePets_Swagger:RootUrl"]?.TrimEnd('/');
