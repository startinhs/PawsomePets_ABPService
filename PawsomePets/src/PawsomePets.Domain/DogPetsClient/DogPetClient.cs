...
{
    public class DogPetClient : Entity<int>, IHasConcurrencyStamp
    {
        ...
        protected DogPetClient()
        {

        }

        public DogPetClient(Guid imageId, float age, float weight, int vaccinations, decimal price, float promotionPecents, bool isStock, string? name = null, string? breed = null, string? gender = null, string? color = null, string? healthStatus = null, string? otherInformation = null)
        {
