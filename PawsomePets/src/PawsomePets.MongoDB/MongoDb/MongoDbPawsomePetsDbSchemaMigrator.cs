...
public class MongoDbPawsomePetsDbSchemaMigrator : IPawsomePetsDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbPawsomePetsDbSchemaMigrator(IServiceProvider serviceProvider)
    {
